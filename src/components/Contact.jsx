...
const Contact = ({ isDarkMode }) => {
  ...
  const contactInfo = [
    { icon: MapPin, title: 'Address', details: ['123 Coffee Street', 'Brew District, BD 12345'] },
    { icon: Phone, title: 'Phone', details: ['+1 (555) 123-4567', '+1 (555) 987-6543'] },
    { icon: Mail, title: 'Email', details: ['hello@brewmaster.com', 'orders@brewmaster.com'] },
    { icon: Clock, title: 'Hours', details: ['Mon-Fri: 6AM - 9PM', 'Sat-Sun: 7AM - 10PM'] }
  ];
  ...
  return (
    <section
      id="contact"
      className={`py-20 px-4 relative overflow-hidden ${isDarkMode ? 'bg-[#171716]' : 'bg-gray-50'}`}
    >
        <div 
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className={`text-xl max-w-3xl mx-auto ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
            }`}>
            Come experience the perfect cup of coffee in our welcoming atmosphere
          </p>
        </div>
        ...
        >
          <div className="relative rounded-lg overflow-hidden shadow-2xl h-96">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              ...
              <p className="text-sm opacity-90">Perfect for work, meetings, or relaxation</p>
            </div>
          </div>
        </div>
        {/* Contact Info + Form */}
        <div className="grid md:grid-cols-2 gap-12 my-16">
          ...
          >
            {contactInfo.map((item, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className={`flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center ${isDarkMode ? 'bg-amber-400/20' : 'bg-amber-100'
                  }`}>
                  <item.icon className={`h-6 w-6 ${isDarkMode ? 'text-amber-400' : 'text-amber-600'
                    }`} />
                </div>
                <div>
                  ...
                  {item.details.map((detail, idx) => (
                    <p key={idx} className={`${isDarkMode ? 'text-gray-100' : 'text-gray-950'}`}>
                      {detail}
                    </p>
                  ))}
                </div>
          ...
          >
            <form
              ...
              className={`rounded-lg shadow-xl p-6 space-y-4 ${isDarkMode ? 'bg-[#242421]' : 'bg-white'
                }`}
            >
              ...
              <input
                ...
                required
                className={`w-full p-3 rounded-md border focus:outline-none ${isDarkMode
        ...
        >
          <div className="relative rounded-lg overflow-hidden shadow-2xl h-96">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3124.134954707338!2d83.45928447481357!3d27.666877127276432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3996854588a65a8f%3A0xef2fff06087a4b7f!2sThe%20Coffee%20Hub!5e1!3m2!1sen!2snp!4v1755269250510!5m2!1sen!2snp"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
